...
public class ProdukBaglogAdapter extends RecyclerView.Adapter<ProdukBaglogAdapter.ViewHolder> {
    private static List<ProdukResponse.ProdukModel> list;
    Context context;

    public ProdukBaglogAdapter(List<ProdukResponse.ProdukModel> list, Context context) {
        ProdukBaglogAdapter.list = list;

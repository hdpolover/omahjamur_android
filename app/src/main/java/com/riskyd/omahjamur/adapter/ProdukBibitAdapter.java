...
public class ProdukBibitAdapter extends RecyclerView.Adapter<ProdukBibitAdapter.ViewHolder> {
    private static List<ProdukResponse.ProdukModel> list;
    Context context;

    public ProdukBibitAdapter(List<ProdukResponse.ProdukModel> list, Context context) {
        ProdukBibitAdapter.list = list;

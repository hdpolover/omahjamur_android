...
import com.riskyd.omahjamur.adapter.ProdukBaglogAdapter;
...
public class BaglogProdukFragment extends Fragment {
    ...
    String kategori = "baglog";

    LinearLayout noData;

    public BaglogProdukFragment() {
        // Required empty public constructor
    }

    public static BaglogProdukFragment newInstance(String param1, String param2) {
        BaglogProdukFragment fragment = new BaglogProdukFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_container_baglog, container, false);
            ...
            apiInterface.getKategoriProdukCustomer(kategori).enqueue(new Callback<ProdukResponse>() {
                ...
                public void onResponse(Call<ProdukResponse> call, Response<ProdukResponse> response) {
                    if (response.body().status) {
                        ...
                        rv.setAdapter(new ProdukBaglogAdapter(list, getContext()));
